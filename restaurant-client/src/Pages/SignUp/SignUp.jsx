...
const SignUp = () => {
    ...
    const onSubmit = (data) => {
        ...
        .then((result)=>{
            ...
            .then(() => { console.log('Profile Info Updated!');}).catch((error) => {console.log(error);});
            reset();
            ...
            <div className="hero-content flex-col lg:flex-row-reverse md:flex-row-reverse p-10 m-10 border-2 shadow-2xl">
                ...
                <div className="card bg-base-100 w-full lg:w-1/2 md:w-1/2 shadow-2xl">
                    ...
                    <form className="card-body py-5" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type="text" placeholder="Enter Photo URL" name='photo' className="input input-bordered" {...register("photo")} required />
                        </div>
                        <div className="form-control">
                        <label className="label">
                        ...
                        <input type="text" placeholder="Type Captcha" ref={captchaRef} onBlur={handleValidateCaptcha} name='captcha' className="input input-bordered" required />
                    ...
                    <p className='text-yellow-500 text-center pb-5'><small> Allready Have An Account ? <Link to={'/login'} className='font-bold'> Login</Link></small></p>
                </div>
            </div>
        </div>
    </>
